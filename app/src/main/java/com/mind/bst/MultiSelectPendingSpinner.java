...
public class MultiSelectPendingSpinner extends AppCompatSpinner implements
    ...
    public MultiSelectPendingSpinner(Context context) {
        super(context);
    ...
    public MultiSelectPendingSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
