...
public class PendingCallAttend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_call_attend);
        getSupportActionBar().setTitle("Client Pending  Calls");
...
//        setSupportActionBar(mToolbar);
    ...
    protected void onStart() {
        ...
        databaseClients.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ViewPendingAttendImg artistAdapter = new ViewPendingAttendImg(PendingCallAttend.this, clients);
    ...
    public void search(String str){
        ...
        ViewPendingAttendImg artistAdapter = new ViewPendingAttendImg(PendingCallAttend.this, myclients);
        //attaching adapter to the listview
