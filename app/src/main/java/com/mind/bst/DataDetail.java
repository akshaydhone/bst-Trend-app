...
public class DataDetail {
  ...
  // String client_cont;
   ...
   // String email;
    ...
    public String getCustomer_Gst_In() {
        return customer_Gst_In;
    }

    public void setCustomer_Gst_In(String customer_Gst_In) {
    ...
    public String getCall_visit_date() {
        return call_visit_date;
    }

    public void setCall_visit_date(String call_visit_date) {
